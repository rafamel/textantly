...
class Navigation extends React.Component {
  ...
  render() {
    ...
    return (
      <AppBar classes={{ root: classes.appBar }} style={{ height }}>
        <Tabs
          value={viewIndex}
          indicatorColor="rgba(255, 255, 255, 0.6)"
          onChange={this.handleChange}
        >
          <Tab {...tabProps} label="Text" icon={<TextFormat />} />
          <Tab {...tabProps} label="Edit Image" icon={<Image />} />
        </Tabs>
      </AppBar>
    );
  }
...
export default compose(withStyles(styles), connector)(Navigation);
